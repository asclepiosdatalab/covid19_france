---
title: " \n Information Covid-19 en France"

output: 
  flexdashboard::flex_dashboard:
    css: "C:/Users/rdlma/Documents/git/covid19_dashboard/css/covid19.css"
    logo: "C:/Users/rdlma/Documents/git/covid19_dashboard/img/adl_2.png"
    highlight: pygments
    social: NULL
    center: true
    smooth_scroll: true
...
data = merge(data[, sum(cas), by = "lib_reg"], data[, sum(new_cas), by = "lib_reg"], by = "lib_reg")
setnames(data, colnames(data), c("lib_reg","cas","new_cas"))
